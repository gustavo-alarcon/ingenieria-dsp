export class UiConfig {
  ...
  private setAdministratorUI(): void {
    ...
    this.spareParts.frequency.toolbar.create = true;
    this.spareParts.frequency.toolbar.bulk = true;
    this.spareParts.frequency.actions.edit = true;
    this.spareParts.frequency.actions.delete = true;
